...
class PromoPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final promos = [
      {'t': 'Cashback 30% di Book Store', 'd': 'Maks. Rp10.000 · s.d. 30 Jun', 'tone': 'red', 'icon': Icons.restaurant_outlined},
      {'t': 'Gratis biaya transfer antarbank', 'd': 'Setiap Jumat · semua bank', 'tone': 'green', 'icon': Icons.send_rounded},
      {'t': 'Diskon 90% pembelian pertama', 'd': 'Khusus pengguna baru', 'tone': 'violet', 'icon': Icons.receipt_long_outlined},
