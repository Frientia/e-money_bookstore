...
///   bookpay://pay?merchant_id=...&merchant_name=...&amount=...
///                      &description=...&reference=...&callback=...
///   https://bookpay.app/pay?merchant_id=...&...  (App Link, opsional)
@immutable
...
class DeeplinkService {
  ...
  bool _isPaymentLink(Uri uri) {
    if (uri.scheme == 'bookpay' && uri.host == 'pay') return true;
    if (uri.scheme == 'https' &&
        uri.host == 'bookpay.app' &&
